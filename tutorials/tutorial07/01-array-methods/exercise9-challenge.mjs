...
const filtered = students.filter((student) => student.major == "Computer Science").toSorted((a,b) => a.grade - b.grade).map((student) => `<p><strong> ${student.name} </strong> ${student.grade} (${student.major}) </p>`);
