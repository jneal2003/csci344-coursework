...
function createTodoItemHTML1(inputStr) {
    return `<li>inputStr</li>`
}
...
const createTodoItemHTML = (inputStr) => {
    return `<li>inputStr</li>`
};
...
function addTodo() {
    ...
    let cleanText = cleanTodoText(text);
    let coolText = createTodoItemHTML(cleanText)
    const todoList = document.querySelector('#todoList');
    todoList.insertAdjacentHTML('beforeend', coolText);
